function [ floatVax ] = uint64le_to_VAXfloatD(uint32le)
%UINT64LE_TO_VAXFLOATD Converts from IEEE-LE (UINT32) to VAXD (float)
...
% http://www.opengroup.org/onlinepubs/9629399/chap14.htm#tagfcjh_20
    ...
    M = C+double(F)./2^56; %VAX Specific 4503599627370496=2^52
